    ...
    extends QAgent
{
    ...
    public TetrisQAgent1(String name)
    {
        super(name);
                                    ...
                                    final Mino potentialAction)
    {
        ...
        */
        ...
        for (int i = 0; i < Board.NUM_COLS; i++) {
            //if (columnHeights[i] >= 10) {
                //heightPenalty += 20;
            //}
            //else if (columnHeights[i] != -1) {
    ...
    public double getReward(final GameView game)
    {
        ...
        */
        ...
        //reward += completedRows * twoRowWeight * 50.0;
        // * 50 or 70?
        //reward += completedRows * 70.0;
